...
class DatabaseView:
    def __init__(self, data):
        ...
        self.databaseView["columns"] = ("id", "fName", "lName", "dob", "mob", "yob", "gender", "address", "phone", "email",  "water clock")
        ...
        self.databaseView.heading("water clock", text= "Water Clock")
        ...
        self.databaseView.column("water clock", width=200)
